        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              {loading ? 'Loading...' : `Showing ${transactions.length} completed transactions`}
            </p>
          </div>
                    ...
                    <div className="px-3 py-2 border-t border-gray-600">
                      <div className="flex gap-2 flex-wrap">
                        ...
                        <button
                          ...
                          className="bg-yellow-600/10 px-3 py-1 rounded text-yellow-500 text-xs hover:bg-yellow-700/20 transition-colors flex items-center gap-1"
                        >
                          <Icon icon="material-symbols:pending" width="14" height="14" />
                          Mark as Pending
                        </button>
                      </div>
                    </div>
