        ...
        {user.KYC && (
          <div className="mt-4 p-3 rounded-lg bg-[#181818]">
            ...
            <div className="mb-3">
              ...
              <Link className="mt-3 px-3 py-1.5 rounded text-xs font-medium bg-yellow-500 text-black hover:bg-yellow-600 transition-colors" href={user.KYC || ""} download={`kyc_document_${user.username || user.email || user.id}.jpg`}>Download KYC Image</Link>
            </div>
