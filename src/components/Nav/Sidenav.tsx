...
const SideNav = () => {
  ...
  return (
    <aside className="hidden md:flex fixed top-0 left-0 h-screen w-[320px] bg-[#12121283] text-white border-r border-gray-800 px-6 py-8 flex-col justify-between shadow-lg z-50">
      {/* Top Section */}
      <div>
        <div className="mb-10">
